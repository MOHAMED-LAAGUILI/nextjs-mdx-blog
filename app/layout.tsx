...
export const metadata: Metadata = {
   description: "Meta Blog is a blog website built with Next.js, TypeScript, and Tailwind CSS. It features a clean and modern design, responsive layout, and supports dark mode.",
   title: "Meta Blog",
};
