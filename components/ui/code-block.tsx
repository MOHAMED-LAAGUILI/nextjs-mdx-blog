...
export const CodeBlock = ({
  ...
  const downloadFile = () => {
    const extMap: Record<string, string> = {
      ...
      tsx: "tsx", python: "py", py: "py", bash: "sh", sh: "sh",
      json: "json", css: "css", html: "html", markdown: "md", md: "md",
      yaml: "yml", yml: "yml", sql: "sql", rust: "rs", go: "go",
      java: "java", ruby: "rb", php: "php", csharp: "cs", cpp: "cpp",
      c: "c", swift: "swift", kotlin: "kt", scala: "scala",
    };
